...
void wrapper_func(thread_startfunc_t func, void* arg, context* context){
...
thread::thread(thread_startfunc_t func, void* arg) {
	...
	try {
		...
		makecontext(this->impl_ptr->thread_context->ucontext_ptr, (void (*)()) wrapper_func, 3, func, arg, this->impl_ptr->thread_context);
...
void cpu::init(thread_startfunc_t func, void* arg) {
    ...
    try {
        ...
        makecontext(ini_context->ucontext_ptr, (void (*)()) wrapper_func, 3, func, arg, ini_context);
